...
```
We can see that there are 100,722 rows and 79 columns in this csv, as well as the data types of those columns, which are imported as strings aka characters (chr), doubles, and 
## Python
