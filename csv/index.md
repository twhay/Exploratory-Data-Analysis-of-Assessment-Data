...
4. In that spreadsheet go to File -> Import 
   <img src=https://github.com/twhay/data-wrangling-toolkit/blob/master/csv/images/google-sheets-file-menu-import.png width=50% height=50% alt="Google Sheets File Menu clicking on the Import menu" title="Google Sheets File Menu clicking on the Import menu">  

5. Go to the upload tab and either find the CSV on your computer or drag and drop it from a file explorer 
   <img src=https://github.com/twhay/data-wrangling-toolkit/blob/master/csv/images/google-sheets-import-upload.png width=50% height=50% alt="Google Sheets Import Upload browser" title="Google Sheets Import Upload browser"> 
6. Choose the location to save the CSV as a spreadsheet and the separator type
    <img src=https://github.com/twhay/data-wrangling-toolkit/blob/master/csv/images/google-sheets-import-preferences.png width=50% height=50% alt="Google Sheets Import File location and separator type" title="Google Sheets Import File location and separator type">
    <img src=https://github.com/twhay/data-wrangling-toolkit/blob/master/csv/images/google-sheets-import-preferences-location.png width=50% height=50% alt="Google Sheets Import File location types" title="Google Sheets Import File location types">
    <img src=https://github.com/twhay/data-wrangling-toolkit/blob/master/csv/images/google-sheets-import-preference-separator.png width=50% height=50% alt="Google Sheets Import File separator types" title="Google Sheets Import File separator types">
7. Refresh the page once the upload is complete and find your uploaded CSV as a Google Sheet
   <img src= width=50% height=50% alt="Google Sheets Import File location and separator type" title="Google Sheets Import File location and separator type">
